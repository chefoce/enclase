...
<title>ENCLASE - Notificaiones</title>
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        <table id="dtMaterialDesignExample" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM notificaciones WHERE docente_id = $id_docente AND rol_notificacion = 1 ORDER BY fecha DESC;";
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn-floating btn-sm btn-danger" href="<?php echo SITEURL; ?>docente/eliminar_notificacion.php?id=<?php echo $id_notificacion; ?>"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                <?php
                                        }
