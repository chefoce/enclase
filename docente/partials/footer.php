  ...
  if ($("#calendar").length > 0) {
    ...
    $('#calendar').fullCalendar({
      ...
      eventRender: function(event, element, view) {
        element.find('.fc-title').append('<div class="dropdown-divider m-0"></div><span>Grupo: ' + event.department + '</span></div><div class="dropdown-divider m-0"></div><span>' + event.description + '</span></div>');
      ...
      events: [
        ...
        ?> {
            ...
            department: '<?php echo $event['grupo']; ?>',
