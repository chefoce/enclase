...
<main>
    <?php
    $sql = "SELECT * FROM docente WHERE activo = 1 AND id_docente = $id_docente";
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row flex-center">
                                ...
                                <a href="<?php echo SITEURL; ?>docente/eliminar_img_perfil.php?id=<?php echo $id; ?>&img_perfil=<?php echo $imagen_perfil; ?>" class="btn btn-danger btn-rounded btn-sm">Eliminar</a>
                            </div>
                        </div>
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form81" class="form-control validate" value="<?php echo $numero_empleado ?>" disabled>
                                        <label for="form81" data-error="wrong" data-success="right"># Empleado</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
...
if (isset($_POST['submit'])) {
    ...
    if ($upload == false) {
        ...
        header('location:' . SITEURL . 'docente/perfil.php');
        die();
    }

    $sql = "UPDATE docente SET img_perfil_nombre = '$image_name' WHERE id_docente = $id";
    $res = mysqli_query($conn, $sql);
    if ($res == true) {
