...
<main>
    ...
    $sql = "SELECT t.nombre,
                ...
                WHERE t.activo = 1 AND t.id_tutor = $id_tutor";
    ...
    if ($res == TRUE) {
        ...
        if ($count > 0) {
            while ($rows = mysqli_fetch_assoc($res)) {
                ...
                $matricula_alumno = $rows['matricula'];
                $email_alumno = $rows['email_alumno'];
            }
        }
    }
    ?>
            ...
            <div class="row">
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row flex-center">
                                ...
                                <a href="<?php echo SITEURL; ?>tutor/eliminar_img_perfil.php?id=<?php echo $id_tutor; ?>&img_perfil=<?php echo $imagen_perfil; ?>" class="btn btn-danger btn-rounded btn-sm">Eliminar</a>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="text-center mt-1-half">
                                            <input type="hidden" name="id" value="<?php echo $id_tutor ?>">
                ...
                <div class="col-lg-8 mb-4">
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form81" class="form-control validate" value="<?php echo $telefono ?>" disabled>
                                        <label for="form81" data-error="wrong" data-success="right">Teléfono</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                    ...
                    <div class="card card-cascade narrower mt-5">
                        <div class="view view-cascade gradient-card-header verde-conalep">
                            <h5 class="mb-0 font-weight-bold">Datos de Alumno</h5>
                        </div>
                        <div class="card-body card-body-cascade text-center">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form1" class="form-control validate" value="<?php echo $nombre_alumno ?>" disabled>
                                        <label for="form1" data-error="wrong" data-success="right">Nombre(s)</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form2" class="form-control validate" value="<?php echo $apellido_alumno ?>" disabled>
                                        <label for="form2" data-error="wrong" data-success="right">Apellido(s)</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form81" class="form-control validate" value="<?php echo $matricula_alumno ?>" disabled>
                                        <label for="form81" data-error="wrong" data-success="right">Matricula</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form82" class="form-control validate" value="<?php echo $email_alumno ?>" disabled>
                                        <label for="form82" data-error="wrong" data-success="right">Email</label>
                                    </div>
                                </div>
                            </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tutor SET img_perfil_nombre = '$image_name' WHERE id_tutor = $id";
    $res = mysqli_query($conn, $sql);
    if ($res == true) {
