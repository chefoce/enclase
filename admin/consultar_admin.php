    ...
    <div class="container-fluid mb-5">
        ...
        <section>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-8">
                        <h5 class="my-4 dark-grey-text font-weight-bold">Tabla Administrador</h5>
                    </div>
                    <div class="col-md-4 d-flex justify-content-end">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="agregar_admin.php">Nuevo Registro</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="importar_datos_admin.php">Importar Datos</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body table-responsive">
                        <table id="tabla_0-3" class="table table-striped" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="<?php echo SITEURL; ?>admin/actualizar_pass_admin.php?id=<?php echo $id; ?>">Cambiar Password</a>
                                                    <a class="btn btn-info btn-sm" href="<?php echo SITEURL; ?>admin/actualizar_admin.php?id=<?php echo $id; ?>">Modificar</a>
                                                        ...
                                                        <div class="modal-dialog modal-notify modal-danger" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer justify-content-center">
                                                                    <a href="<?php echo SITEURL; ?>admin/eliminar_admin.php?id=<?php echo $id; ?>" type="button" class="btn btn-danger">Eliminar</a>
