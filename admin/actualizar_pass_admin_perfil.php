...
<main>
    <div class="container-fluid">
        <section class="section card mb-5">
            <div class="card-body">
                <a href="pefil.php"><i class="fas fa-arrow-circle-left verde-item" style="font-size: 35px;"></i></a>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <label class="form-label" for="passwordActual">Password Actual</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-outline">
...
if (isset($_POST['submit'])) {
    if(isset($_POST['id']) && isset($_POST['passwordActual']) && isset($_POST['passwordNuevo']) && isset($_POST['rePasswordNuevo'])){
        $id = $_POST['id'];
        ...
        if (!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password_nuevo) < 8) {
            ...
            $_SESSION['id'] = $id;
            header('location:' . SITEURL . 'admin/actualizar_pass_admin.php');
            die();
        }
        if (strcmp($password_nuevo, $password_confirmar) == 0) {
            ...
            if ($res == TRUE) {
                ...
                $pass = $rows['password'];
                if (($count == 1) && (password_verify($password_actual, $pass))) {
                    $password_nuevo = password_hash($password_nuevo, PASSWORD_DEFAULT);
                    $sql2 = "UPDATE administrador SET password = '$password_nuevo' WHERE id_admin = $id";
                    ...
                    $_SESSION['errorP'] = "<div class='alert alert-danger'>Password Actual Incorrecto</div>";
                    $_SESSION['id'] = $id;
                    header('location:' . SITEURL . 'admin/actualizar_pass_admin_perfil.php');
                    die();
                }
            }
        } else {
