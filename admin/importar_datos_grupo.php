        ...
        <section class="section card mb-5">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                    <a class="btn verde-conalep float-right waves-effect waves-light" href="exportar_datos_grupo.php" role="button">
                            <i class="fas fa-file-download mr-2"></i>
                            Generar Archivo para Carga
                        </a>
                    </div>
                </div>
                <h1 class="text-center my-5 h1">Importar Datos Grupo</h1>
                <?php
                ...
                ?>
                <form action="importar_datos_grupo_2.php" method="POST" enctype="multipart/form-data">
                    <div class="row mb-4">
                        <div class="col">
        ...
        if (!empty($sheetData)) {
            ...
            for ($i = 1; $i < count($sheetData); $i++) { //skipping first row
                ...
                if ($count > 0) {
                    ...
                    $sql2 = ("INSERT INTO grupo (nombre, activo)VALUES('$nombre', 1)");
