    ...
    <div class="container-fluid mb-5">
        <section>
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-8">
                        <h5 class="my-4 dark-grey-text font-weight-bold">Importar Datos Docente</h5>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                                            ...
                                            if ($sheetData[2][0] != "") {
                                                for ($i = 2; $i < count($sheetData); $i++) { //skipping first row
                                                    ...
                                                    if ($count > 0) {
                                                        ...
                                                        if ($numero_empleado == "") {
                                                            $numero_empleado = "<div class='alert-s alert-danger'>Error..Campo vacío</div>";
                                                            $error[$i] = true;
                                                        }
                                                        $soloNumeros = preg_match('/^[0-9]{8}$/', $numero_empleado);
                                                        if (!$soloNumeros) {
                                                            $numero_empleado = "<div class='alert-s alert-danger'>Error..8 dígitos y solo números</div>";
                                                            $error[$i] = true;
                                                        }
                                                        $email = $sheetData[$i][3];
                                                        if ($email == "") {
                        ...
                        <div class="row">
                            <div class="col-6 mx-auto">
                                <a href="importar_datos_docente.php" class="btn btn-danger btn-block">Regresar</a>
                            </div>
                            <div class="col-6 mx-auto">
                                <button <?php if ($err != 0) {
                                            echo "disabled";
...
<script src="../js/archivo_validado_docente.js"></script>