    ...
    <div class="container-fluid mb-5">
        <section>
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-8">
                        <h5 class="my-4 dark-grey-text font-weight-bold">Importar Datos Tutor</h5>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        if (isset($_FILES['file']['name']) && in_array($_FILES['file']['type'], $file_mimes)) {
                                            ...
                                            $last_row=$spreadsheet->getActiveSheet()->getHighestRow('F'); 
                                            $sheetData =$spreadsheet->getActiveSheet()->rangeToArray('A1:F'.$last_row, NULL, True, True);
                                            if ($sheetData[2][0] != "") {
                        ...
                        <div class="row">
                            <div class="col-6 mx-auto">
                                <a href="importar_datos_tutor.php" class="btn btn-danger btn-block">Regresar</a>
                            </div>
                            <div class="col-6 mx-auto">
                                <button <?php if ($err != 0) {
                                            echo "disabled";
...
<script src="../js/archivo_validado_tutor.js"></script>