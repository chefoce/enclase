        ...
        <section class="section card mb-5">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a class="btn verde-conalep float-right waves-effect waves-light" href="exportar_datos_tutor.php" role="button">
                            <i class="fas fa-file-download mr-2"></i>
                            Generar Archivo para Carga
                        </a>
                    </div>
                </div>
                <h1 class="text-center my-5 h1">Importar Datos Tutor</h1>
                <?php
                ...
                ?>
                <form action="importar_datos_tutor_2.php" method="POST" enctype="multipart/form-data">
                    <div class="row mb-4">
                        <div class="col">
    ...
    if (isset($_FILES['file']['name']) && in_array($_FILES['file']['type'], $file_mimes)) {
        ...
        if (!empty($sheetData)) {
            ...
            for ($i = 2; $i < count($sheetData); $i++) { //skipping first row
                ...
                $telefono = $sheetData[$i][4];
                $alumno_id = $sheetData[$i][5];
                ...
                if ($count > 0) {
                    ...
                    $sql2 = ("INSERT INTO tutor(nombre,apellido,email,password,telefono,alumno_id,rol_id,activo)VALUES('$nombre', '$apellido', '$email', '$password', '$telefono', $alumno_id, 4, 1)");
        ...
        header("location:" . SITEURL . 'admin/importar_datos_tutor.php');
    }
}
*/
?>