    ...
    <div class="container-fluid mb-5">
        <section>
            <div class="col-md-12">
                <div class="row">
                    <div class="col">
                        <a href="consultar_asistencia.php"><i class="my-4 fas fa-arrow-circle-left btn-atras"></i></a>
                    </div>
                ...
                <div class="row">
                    ...
                    $id_alumno = $_GET['id'];
                    if($id_alumno==""){
                        header("location:" . SITEURL . '/admin/consultar_asistencia.php');
                    }
                        ...
                        <div class="col-md-4">
                            <select name="materia" required class="mdb-select colorful-select dropdown-primary md-form" searchable="Buscar..">
                                ...
                                if ($res == TRUE) {
                                    $count = mysqli_num_rows($res);
                                    if ($count > 0) {
                                        ?> <option value="" disabled selected>Selecciona Materia</option> <?php
