...
<main>
    <?php
    $sql = "SELECT * FROM administrador WHERE activo = 1 AND id_admin= $id_admin";
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row flex-center">
                                ...
                                <a href="<?php echo SITEURL; ?>admin/eliminar_img_perfil.php?id=<?php echo $id_admin; ?>&img_perfil=<?php echo $imagen_perfil; ?>" class="btn btn-danger btn-rounded btn-sm">Eliminar</a>
                            </div>
                        </div>
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                                        <input type="text" id="form81" class="form-control validate" value="Administrador" disabled>
                                        <label for="form81" data-error="wrong" data-success="right">Rol</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="md-form mb-0">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a class="btn btn-primary btn-sm" href="<?php echo SITEURL; ?>admin/actualizar_pass_admin_perfil.php?id=<?php echo $id_admin; ?>">Cambiar Password</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($upload == false) {
        ...
        header('location:' . SITEURL . 'admin/perfil.php');
        die();
    }

    $sql = "UPDATE administrador SET img_perfil_nombre = '$image_name' WHERE id_admin = $id";
    $res = mysqli_query($conn, $sql);
    if ($res == true) {
